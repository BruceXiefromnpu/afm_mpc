...
Nbar = K_lqr*Nx + Nu;
gdrift_inv = 1/gdrift;
sim_struct = struct('K_lqr', K_lqr, 'du_max', du_max*100, 'PLANT', PLANT,...
             'mpc_on', 0, 'Nx', Nx_r, 'Nu', Nu_r, 'Nx_d', Nx_d, 'Nu_d', Nu_d,...
             'thenoise', thenoise, 'obs_has_deltaUk', false,...
             'sys_obs', sys_obsDist, 'L', L_dist, 'state_mode', 3,...
             'step_amp', 0.25, 'r', r, 'w', w, 'hyst_mode', 1,...
           'gdrift', gdrift);
clc
[y_linear, u_linear, dU] = sim_AFM(sim_struct, ref_traj);

linOpts = stepExpOpts('pstyle', '--g', 'TOL', TOL, 'y_ref', ref_f_1,...
