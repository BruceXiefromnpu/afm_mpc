...
%   \centering
%   % [grid]
%   \begin{overpic}[width=1\columnwidth]{figures/blocks/ss_block_diagram_cropped.pdf}
%     \put(63.,19){\tiny{$\mathcal{F}${\raisebox{1.15ex}{$\scriptscriptstyle -1$}}$[\cdot]$}}
%     \put(76.4,19){\tiny{$\mathcal{F}[\cdot]$}}
% % \includegraphics                
% \end{overpic}
%   \caption{The overall plant model consists of a vibrational component, $G_{vib}$, a drift model $G_{d}$ and a hysteresis model $\mathcal{F}[\cdot]$. }
%   \label{fig:ss_bd}
