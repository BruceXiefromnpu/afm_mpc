...
\begin{figure}
  \includesvg[width=.5\textwidth]{figures/lqr_locus_constsig_0p9.svg}
...
\begin{figure*}
  \begin{minipage}{0.48\textwidth}
    \includesvg[scale=0.65]{figures/PMGM_vs_gamma_constsig_0p9.svg}
    \caption{Phase and Gain Margins as $\gamma$ is increased.}
  \end{minipage}
  \hfil
  \begin{minipage}{0.48\textwidth}
    \includesvg[scale=0.65]{figures/GainS_TS_vs_gamma_constsig_0p9.svg}
