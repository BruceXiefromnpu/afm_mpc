...
% addpath(genpath(fullfile(getMatPath, 'miscScripts')))
...
saveOn = 1; % set this to 0 to avoid saving the computed FRFs.
...
% ----------------------------------------------------------------------- %
% You hould not need to touch anything below here. 
...
if saveOn +1
        save('FRF_data_current_caponly2.mat', 'modelFit');
end
