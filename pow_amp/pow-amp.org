...
2. Piezos are not actually just simple capacitors. Is it possible that I am barking up the wroing tree? First, I believe that piezos are actually non-linear capacitors and that their effective capacitance can change over different operating regimes.
