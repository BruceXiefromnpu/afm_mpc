...
save('gmpmS_data.mat', 'GM_s1', 'PM_s1', 'Sens_gain1', 'TS_s1', 'GM_s2',...
  'PM_s2', 'Sens_gain2', 'TS_s2') 
else
  load('gmpmS_data.mat')
end
% -------------------------------------------------------------------------
...
% 'Position', [-0.0133 0.8715 1.2618 0.1242])
% leg3 = legend([h_sens2, hts_mpc_exp2, h_ts_sim2]);
% set(leg3, 'Position', [0.1514 0.8066 0.7184 0.2091], 'Box', 'off')
