...
for k=1:4
  hands2 (k) = plot(ax2, abs(step_exps_CS.step_ref.step_diff_amps(2:end)),...
...
ylm2 = ylim();
set(ax2, 'YScale', 'log')
set(ax2, 'Visible', 'off', 'YLim', [2, max([ylm1(2), ylm2(2)])]);
set(ax1, 'Visible', 'on', 'YLim', [2, max([ylm1(2), ylm2(2)])]);

grid on
leg1 = legend(hands1);
set(leg1, 'Box', 'off', 'Position', [0.1020 0.7220 0.3539 0.2362], 'FontSize', 8)
pos1 = leg1.Position();

leg2 = legend(hands2);
pos2 = leg2.Position(); 
%                                     lft              bt 
set(leg2, 'Box', 'off', 'Position', [pos1(1)+ pos1(3), pos1(2), pos2(3:4)], 'FontSize', 8)
