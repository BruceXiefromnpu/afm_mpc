...
{
    int argc = 3;
    char* argv[4] = {"Compare_SCTL_C3ADE5BE76064AA39E7EE6565DE88692.dll", "-nolog", "-sysgen"};
    ...
    xilinxcorelib_a_3260675181_3212880686_init();
    xilinxcorelib_a_3269659688_3212880686_init();
    work_a_0310866826_2532281617_init();


    xsi_register_tops("work_a_0310866826_2532281617");
