...
step_data_timeopt = StepDataTimeOpt(step_params_timeopt, 'savedata', true,...
    'file', 'data/timeopt_ref_data_test.mat');
step_data_clqr = StepDataCLQR(step_params_clqr, 'savedata', true,...
    'file', 'data/clqr_ref_data_test.mat');
...
%%
clear StepDataTimeOpt
step_data_clqr = step_data_clqr.build_clqr_trajs('force', 0, 'fid', fid, 'verbose', 2);
%%
clc
step_data_timeopt = step_data_timeopt.build_timeopt_trajs('force', 0, 'fid', fid, 'verbose', 2);
